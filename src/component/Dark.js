...
function Dark() {
  ...
  return (
    <div className="fixed sm:top-4 sm:right-4 top-2 right-2">
      <button className='sm:p-3 p-2 rounded-full dark:bg-[#2B2A2A] bg-[#EEEEEE] text-slate-900 dark:text-white hover:bg-[#2ba4fa] dark:hover:bg-[#2ba4fa] ease-in duration-300' onClick={darkModeHandler}>

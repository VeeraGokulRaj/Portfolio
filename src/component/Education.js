        ...
        <div className="relative my-10 sm:my-20">
          ...
          {timelineItems.map((item, index) => (
            ...
            >
              ...
              <div
                className={`order-1 w-16 h-16 rounded-full bg-[#2196f3] dark:bg-[#42aefc] flex items-center justify-center ${
                  index % 2 === 0 && animationInView
                    ...
                    : "mr-6"
                } hover:-translate-y-6 ease-in duration-300`} ref={animation}
              >
                {item.icon}
              </div>
            </div>
